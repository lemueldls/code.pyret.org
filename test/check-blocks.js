...
describe("Rendering check blocks", function () {
  ...
  var tests = [
    ...
    [
      "raises-fail",
      "check: raise('ab') raises 'c' end",
      [[["unexpected exception"]]],
    ],
    [
      "raises-other-than-fail",
      "check: raise('ab') raises-other-than 'b' end",
      [[["Got exception"]]],
    ],
    [
      "raises-other-than-pass",
      "check: raise('ab') raises-other-than 'c' end",
      [[["Passed"]]],
    ],
    ["does-not-raise-fail", "check: raise('') does-not-raise end", [[['""']]]],
    ["does-not-raise-pass", "check: '' does-not-raise end", [[["Passed"]]]],
    [
      "raises-satisfies-pass",
      "check: raise('a') raises-satisfies _ == 'a' end",
      [[["Passed"]]],
    ],
    [
      "raises-satisfies-fail",
      "check: raise('a') raises-satisfies _ == 'b' end",
      [[["failed"]]],
    ],
    [
      "raises-violates-fail",
      "check: raise('a') raises-violates _ == 'a' end",
      [[["failed"]]],
    ],
    [
      "raises-violates-pass",
      "check: raise('a') raises-violates _ == 'b' end",
      [[["Passed"]]],
    ],
