({
  ...
  provides: {},
  theModule: function(runtime, namespace, uri, imageLibrary, jsnums) {
    var image = runtime.getField(imageLibrary, "internal")
    
    function makeImageLibrary(moduleName, annots) {
      ...
      const annNumberNonNegative = annots.annNumNonNegative
      ...
      var imageListFoldIndex = function(function_, lst, base) {
        var current = lst
        var ans = base
        ...
        while (runtime.unwrap(ffi.isLink(current))) {
          ...
          ans = function_(ans, index++, unwrapImage(f))
      ...
      function makeImage(index) {
        return runtime.makeOpaque(index, image.imageEquals)
      }
      ...
      const c = function(name, ...argumentsAndAnns) {
        runtime.checkArgsInternalInline(moduleName, name, ...argumentsAndAnns)
      }
      const c1 = function(name, argument, ann) {
        runtime.checkArgsInternal1(moduleName, name, argument, ann)
      }
      const c2 = function(name, argument1, ann1, argument2, ann2) {
        runtime.checkArgsInternal2(moduleName, name, argument1, ann1, argument2, ann2)
      }
      const c3 = function(name, argument1, ann1, argument2, ann2, argument3, ann3) {
        runtime.checkArgsInternal3(moduleName, name, argument1, ann1, argument2, ann2, argument3, ann3)
      }
      //////////////////////////////////////////////////////////////////////
      ...
      f("circle", function(radius, maybeMode, maybeColor) {
        ...
        c3("circle", radius, annNumberNonNegative, maybeMode, annMode, maybeColor, annColor)
      ...
      f("overlay-list", function(maybeImgs) {
        ...
        return makeImage(imageListFoldIndex(function(accumulator, index, img) {
          return index == 0 ? img : image.makeOverlayImage(accumulator, "pinhole", "pinhole", 0, 0, img, "pinhole", "pinhole")
        }, imgs, image.makeSceneImage(0, 0, [], false, colorDatabase.get("transparent"))))
      })
      ...
      f("overlay-align-list", function(maybePlaceX, maybePlaceY, maybeImgs) {
        ...
        var imgs = unwrapListofImage(maybeImgs)
        return makeImage(imageListFoldIndex(function(accumulator, index, img) {
          return index == 0 ? img : image.makeOverlayImage(accumulator, placeX, placeY, 0, 0, img, placeX, placeY)
        }, imgs, image.makeSceneImage(0, 0, [], false, colorDatabase.get("transparent"))))
      })
      ...
      f("underlay-list", function(maybeImgs) {
        ...
        var imgs = unwrapListofImage(maybeImgs)
        return makeImage(imageListFoldIndex(function(accumulator, index, img) {
          return index == 0 ? img : image.makeOverlayImage(img, "pinhole", "pinhole", 0, 0, accumulator, "pinhole", "pinhole")
        }, imgs, image.makeSceneImage(0, 0, [], false, colorDatabase.get("transparent"))))
      })
      ...
      f("underlay-align-list", function(maybePlaceX, maybePlaceY, maybeImgs) {
        ...
        var imgs = unwrapListofImage(maybeImgs)
        return makeImage(imageListFoldIndex(function(accumulator, index, img) {
          return index == 0 ? img : image.makeOverlayImage(img, placeX, placeY, 0, 0, accumulator, placeX, placeY)
        }, imgs, image.makeSceneImage(0, 0, [], false, colorDatabase.get("transparent"))))
      })
      ...
      f("beside-list", function(maybeImgs) {
        ...
        var imgs = unwrapListofImage(maybeImgs)
        return makeImage(imageListFoldIndex(function(accumulator, index, img) {
          return index == 0 ? img : image.makeOverlayImage(accumulator, "right", "center", 0, 0, img, "left", "center")
        }, imgs, image.makeSceneImage(0, 0, [], false, colorDatabase.get("transparent"))))
      })
      ...
      f("beside-align-list", function(maybePlaceY, maybeImgs) {
        ...
        var imgs = unwrapListofImage(maybeImgs)
        return makeImage(imageListFoldIndex(function(accumulator, index, img) {
          return index == 0 ? img : image.makeOverlayImage(accumulator, "right", placeY, 0, 0, img, "left", placeY)
        }, imgs, image.makeSceneImage(0, 0, [], false, colorDatabase.get("transparent"))))
      })
      ...
      f("above-list", function(maybeImgs) {
        ...
        var imgs = unwrapListofImage(maybeImgs)
        return makeImage(imageListFoldIndex(function(accumulator, index, img) {
          return index == 0 ? img : image.makeOverlayImage(accumulator, "middle", "bottom", 0, 0, img, "middle", "top")
        }, imgs, image.makeSceneImage(0, 0, [], false, colorDatabase.get("transparent"))))
      })
      ...
      f("above-align-list", function(maybePlaceX, maybeImgs) {
        ...
        var imgs = unwrapListofImage(maybeImgs)
        return makeImage(imageListFoldIndex(function(accumulator, index, img) {
          return index == 0 ? img : image.makeOverlayImage(accumulator, placeX, "bottom", 0, 0, img, placeX, "top")
        }, imgs, image.makeSceneImage(0, 0, [], false, colorDatabase.get("transparent"))))
      })
      ...
      f("below-list", function(maybeImgs) {
        ...
        var imgs = unwrapListofImage(maybeImgs)
        return makeImage(imageListFoldIndex(function(accumulator, index, img) {
          return index == 0 ? img : image.makeOverlayImage(img, "middle", "bottom", 0, 0, accumulator, "middle", "top")
        }, imgs, image.makeSceneImage(0, 0, [], false, colorDatabase.get("transparent"))))
      })
      ...
      f("below-align-list", function(maybePlaceX, maybeImgs) {
        ...
        var imgs = unwrapListofImage(maybeImgs)
        return makeImage(imageListFoldIndex(function(accumulator, index, img) {
          return index == 0 ? img : image.makeOverlayImage(img, placeX, "bottom", 0, 0, accumulator, placeX, "top")
        }, imgs, image.makeSceneImage(0, 0, [], false, colorDatabase.get("transparent"))))
      })
      ...
      f("empty-scene", function(maybeWidth, maybeHeight) {
        ...
        c2("empty-scene", maybeWidth, annNumberNonNegative, maybeHeight, annNumberNonNegative)
        var width = jsnums.toFixnum(maybeWidth)
        var height = jsnums.toFixnum(maybeHeight)
        return makeImage(
          image.makeSceneImage(width, height, [], true, colorDatabase.get("transparent")))
      })
      f("empty-color-scene", function(maybeWidth, maybeHeight, maybeColor) {
        checkArity(3, arguments, "empty-color-scene", false)
        c3("empty-color-scene", maybeWidth, annNumberNonNegative, maybeHeight, annNumberNonNegative, maybeColor, annColor)
        var width = jsnums.toFixnum(maybeWidth)
        var height = jsnums.toFixnum(maybeHeight)
        var color = unwrapColor(maybeColor)
        return makeImage(
      ...
      f("put-image", function(maybePicture, maybeX, maybeY, maybeBackground) {
        ...
        if (image.isScene(background)) {
          ...
          var newScene = image.makeSceneImage(background.getWidth(), background.getHeight(), [], false, colorDatabase.get("transparent"))
      ...
      f("crop", function(maybeX, maybeY, maybeWidth, maybeHeight, maybeImg) {
        ...
        c("crop",
          maybeX, annReal,
          maybeY, annReal,
          maybeWidth, annNumberNonNegative,
          maybeHeight, annNumberNonNegative,
          maybeImg, annImage)
        var x = jsnums.toFixnum(maybeX)
        var y = jsnums.toFixnum(maybeY)
        var width = jsnums.toFixnum(maybeWidth)
      ...
      f("square", function(maybeSide, maybeMode, maybeColor) {
        ...
        c3("square", maybeSide, annNumberNonNegative, maybeMode, annMode, maybeColor, annColor)
      ...
      f("regular-polygon", function(maybeLength, maybeCount, maybeMode, maybeColor) {
        ...
        c("regular-polygon",
          maybeLength, annNumberNonNegative,
      ...
      f("wedge", function(maybeRadius, maybeAngle, maybeMode, maybeColor) {
        ...
        c("wedge",
          maybeRadius, annNumberNonNegative,
          maybeAngle, annAngle,
          maybeMode, annMode,
          maybeColor, annColor)
      ...
      f("triangle", function(maybeSide, maybeMode, maybeColor) {
        ...
        c3("triangle", maybeSide, annNumberNonNegative, maybeMode, annMode, maybeColor, annColor)
        var side = jsnums.toFixnum(maybeSide)
        var mode = unwrapMode(maybeMode)
        var color = unwrapColor(maybeColor)
        return makeImage(
      ...
      f("triangle-sas", function(maybeSideA, maybeAngleB, maybeSideC, maybeMode, maybeColor) {
        ...
        c("triangle-sas",
          maybeSideA, annNumberNonNegative,
          maybeAngleB, annAngle,
          maybeSideC, annNumberNonNegative,
          maybeMode, annMode,
          maybeColor, annColor)
      ...
      f("triangle-sss", function(maybeSideA, maybeSideB, maybeSideC, maybeMode, maybeColor) {
        ...
        c("triangle-sss",
          maybeSideA, annNumberNonNegative,
          maybeSideB, annNumberNonNegative,
          maybeSideC, annNumberNonNegative,
          maybeMode, annMode,
          maybeColor, annColor)
        var sideA = jsnums.toFixnum(maybeSideA)
      ...
      f("right-triangle", function(maybeSide1, maybeSide2, maybeMode, maybeColor) {
        ...
        c("right-triangle",
          maybeSide1, annNumberNonNegative,
          maybeSide2, annNumberNonNegative,
          maybeMode, annMode,
          maybeColor, annColor)
      ...
      f("isosceles-triangle", function(maybeSide, maybeAngleC, maybeMode, maybeColor) {
        ...
        c("isosceles-triangle",
          maybeSide, annNumberNonNegative,
          maybeAngleC, annAngle,
          maybeMode, annMode,
          maybeColor, annColor)
        var side = jsnums.toFixnum(maybeSide)
      ...
      f("star", function(maybeSide, maybeMode, maybeColor) {
        ...
        c3("star", maybeSide, annNumberNonNegative, maybeMode, annMode, maybeColor, annColor)
        var side = jsnums.toFixnum(maybeSide)
        var mode = unwrapMode(maybeMode)
        var color = unwrapColor(maybeColor)
        return makeImage(
      ...
      f("star-sized", function(maybePointCount, maybeOuter, maybeInner, maybeMode, maybeColor) {
        ...
        c("star-sized",
          ...
          maybeOuter, annNumberNonNegative,
          maybeInner, annNumberNonNegative,
          maybeMode, annMode,
          maybeColor, annColor)
      ...
      f("name-to-color", function(maybeName) {
        ...
        var name = maybeName
        var c = colorDatabase.get(String(name))
        return c ? runtime.ffi.makeSome(c) : runtime.ffi.makeNone()
      })
      f("color-named", function(maybeName) {
        checkArity(1, arguments, "color-named", false)
        c1("color-named", maybeName, runtime.String)
        var name = maybeName
        var value = colorDatabase.get(String(name))
        if (value) {
          return runtime.wrap(value)
        }
        throwMessage("Unknown color name '" + String(name) + "'")
      })
      
      values["empty-image"] = runtime.makeOpaque(image.makeSceneImage(0, 0, [], true, colorDatabase.get("transparent")))

      return values
    }
    return runtime.makeJSModuleReturn({
      makeImageLib: makeImageLibrary
    })
  }
})
