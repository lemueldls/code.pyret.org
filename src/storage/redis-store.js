...
function makeStorage(client) {
  ...
  function createUser(data) {
    ...
    return Q.ninvoke(client, "hmset", [
      ...
      return getUserByGoogleId(data.google_id);
    });
  }
  ...
  function createSharedProgram(programId, userId) {
    ...
    return Q.ninvoke(client, "hmset", [
      ...
      return getSharedProgram(programId);
    });
  }
...
export default { makeStorage: makeStorage };
