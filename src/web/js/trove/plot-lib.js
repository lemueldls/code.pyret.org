({
  requires: [{ "import-type": "builtin", name: "d3-lib" }],
  ...
  theModule: function (RUNTIME, NAMESPACE, uri, CLIB, jsnums, d3, D3TIP) {
    ...
    function appendAxisLabel(canvas, windowOptions, width, height, posX, posY) {
      ...
      axisLabel
        ...
        .attr("x", posY * (width - 1))
        .attr("y", -10)
        .html(libraryJS.htmlspecialchars(RUNTIME.getField(windowOptions, "y-axis")))
      ...
      axisLabel
        ...
        .html(libraryJS.htmlspecialchars(RUNTIME.getField(windowOptions, "x-axis")))
    ...
    function genericPlot(restarter, windowOptions, scatterPlots, linePlots) {
      ...
      numberSamplesC.val(RUNTIME.num_to_string(gf(windowOptions, "num-samples")))
      ...
      controller.append(
        $("<button/>", {
          ...
          .click(function () {
            ...
            var xMin_value = newWindow["x-min"]
            var xMax_value = newWindow["x-max"]
      ...
      controller.append(
        $("<button/>", {
          ...
          .click(function () {
            ...
            var yMin_value = newWindow["y-min"]
            var yMax_value = newWindow["y-max"]
