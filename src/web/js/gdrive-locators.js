  ...
  function makeLocatorConstructors(
      ...
      return runtime.pauseStack(function(restarter) {
        ...
        fileP.then(function(file) {
          ...
          function getModule(self) {
            return runtime.pauseStack(function(getModuleRestart) {
              contentsP.fail(function(failure) {
                getModuleRestart.error(runtime.ffi.makeMessageException(contentRequestFailure(failure)))
              })
              contentsP.then(function(pyretString) {
                CPO.documents.set(uri, new CodeMirror.Doc(pyretString, "pyret"))
                var returnValue = gmf(compileLibrary, "pyret-string").app(pyretString)
                getModuleRestart.resume(returnValue)
              })
            })
          }
          ...
          function getDependencies(self) {
            return runtime.safeCall(function() {
              ...
              return runtime.safeTail(function() {
                return gmf(compileLibrary, "get-standard-dependencies").app(module, uri)
              })
          ...
          function getProvides(self) {
            return runtime.safeCall(function() {
              ...
              return runtime.safeTail(function() {
                return gmf(compileLibrary, "get-provides").app(module, uri)
              })
          ...
          function getCompileEnvironment(_) {
          ...
          restarter.resume(runtime.makeObject({
            ...
            "get-compile-env": m0(getCompileEnvironment),
            "uri": m0(getUri),
            "name": m0(name),
    ...
    function makeSharedGDriveLocator(filename, id) {
      ...
      return runtime.pauseStack(function(restarter) {
        ...
        contentsP.then(function(fileAndContents) {
          ...
          function getModule(self) {
            return ast ? ast : runtime.safeCall(function() {
              return gmf(parsePyret, "surface-parse").app(contents, uri)
            }, function(returnValue) {
              ast = gmf(compileLibrary, "pyret-ast").app(returnValue)
              return ast 
    ...
    function makeGDriveJSLocator(filename, id) {
      ...
      return runtime.pauseStack(function(restarter) {
        ...
        Q.spread([contentsP, fileP], function(module, file) {

          var uri = "gdrive-js://" + file.getUniqueId()

          var rawModule = gmf(builtinModules, "builtin-raw-locator-from-str").app(module)
          return runtime.safeCall(function() {
    ...
    function makeCompiledGDriveJSLocator(filename, id) {
      ...
      return runtime.pauseStack(function(restarter) {
        ...
        Q.spread([loadedP, fileP], function(module, file) {
          ...
          function getDependencies(self) {
            return runtime.pauseStack(function(restarter) {
              ...
              loader.safeEval(module.contents, {define: define})
            })
                ...
                var define = function(_, callback) {
                  restarter.resume(
                    runtime.ffi.makeSome(
                      gmf(compileLibrary, "pre-loaded").app(
